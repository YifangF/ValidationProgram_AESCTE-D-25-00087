...
set(l,'fontsize',12);
set(l,'position',[0.62,0.22,0.18,0.07]);
xlabel({'Time (s)','(B)'});
...
plot(RLASMC_t(1,2:60001),diff(ASMC_phi)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle','-.');
hold on
grid on
...
set(gca,'LineWidth',0.9);
set(gca,'fontsize',13);
plot(RLASMC_t(1,2:60001),diff(RLSMC_phi)./diff(RLASMC_t)/57.3,'LineWidth',2,'LineStyle',':');
plot(RLASMC_t(1,2:60001),diff(RLASMC_phi)./diff(RLASMC_t)/57.3,'LineWidth',1.5);
plot(RLASMC_t(1,2:60001),diff(RLASMC_phid)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle','--');
...
plot(RLASMC_t(1,2:60001),diff(ASMC_theta)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle','-.');
hold on
grid on
set(gca,'YTick',[-0.5:0.05:0.5]);
set(gca,'Box','off');
...
set(gca,'LineWidth',0.9);
set(gca,'fontsize',13);
plot(RLASMC_t(1,2:60001),diff(RLSMC_theta)./diff(RLASMC_t)/57.3,'LineWidth',2,'LineStyle',':');
plot(RLASMC_t(1,2:60001),diff(RLASMC_theta)./diff(RLASMC_t)/57.3,'LineWidth',1.5);
plot(RLASMC_t(1,2:60001),diff(RLASMC_thetad)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle','--');
...
plot(RLASMC_t(1,2:60001),diff(ASMC_psi)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle','-.');
hold on
grid on
set(gca,'YTick',[-0.5:0.05:0.5]);
set(gca,'Box','off');
...
set(gca,'LineWidth',0.9);
set(gca,'fontsize',13);
plot(RLASMC_t(1,2:60001),diff(RLSMC_psi)./diff(RLASMC_t)/57.3,'LineWidth',2,'LineStyle',':');
plot(RLASMC_t(1,2:60001),diff(RLASMC_psi)./diff(RLASMC_t)/57.3,'LineWidth',1.5);
plot(RLASMC_t(1,2:60001),diff(RLASMC_psid)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle','--');
...
s1 = subplot(1,3,1);
set(s1,'position',[0.07,0.23,0.27,0.72]);
plot(RLASMC_t(1,2:60001),diff(RLASMC_phid)./diff(RLASMC_t)/57.3 - diff(ASMC_phi)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle',':');
hold on
grid on
set(gca,'YTick',[-0.5:0.05:0.5]);
set(gca,'Box','off');
...
set(gca,'LineWidth',0.9);
set(gca,'fontsize',13);
plot(RLASMC_t(1,2:60001),diff(RLASMC_phid)./diff(RLASMC_t)/57.3 - diff(RLSMC_phi)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle','-.');
plot(RLASMC_t(1,2:60001),diff(RLASMC_phid)./diff(RLASMC_t)/57.3 - diff(RLASMC_phi)./diff(RLASMC_t)/57.3,'LineWidth',1.5);
...
s2 = subplot(1,3,2);
set(s2,'position',[0.4,0.23,0.27,0.72]);
plot(RLASMC_t(1,2:60001),diff(RLASMC_thetad)./diff(RLASMC_t)/57.3 - diff(ASMC_theta)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle',':');
hold on
grid on
set(gca,'YTick',[-0.5:0.05:0.5]);
set(gca,'Box','off');
...
set(gca,'LineWidth',0.9);
set(gca,'fontsize',13);
plot(RLASMC_t(1,2:60001),diff(RLASMC_thetad)./diff(RLASMC_t)/57.3 - diff(RLSMC_theta)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle','-.');
hold on
plot(RLASMC_t(1,2:60001),diff(RLASMC_thetad)./diff(RLASMC_t)/57.3 - diff(RLASMC_theta)./diff(RLASMC_t)/57.3,'LineWidth',1.5);
...
s3 = subplot(1,3,3);
set(s3,'position',[0.72,0.23,0.27,0.72]);
plot(RLASMC_t(1,2:60001),diff(RLASMC_psid)./diff(RLASMC_t)/57.3 - diff(ASMC_psi)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle',':');
hold on
grid on
set(gca,'YTick',[-0.5:0.05:0.5]);
set(gca,'Box','off');
...
set(gca,'LineWidth',0.9);
set(gca,'fontsize',13);
plot(RLASMC_t(1,2:60001),diff(RLASMC_psid)./diff(RLASMC_t)/57.3 - diff(RLSMC_psi)./diff(RLASMC_t)/57.3,'LineWidth',1.5,'LineStyle','-.');
hold on
plot(RLASMC_t(1,2:60001),diff(RLASMC_psid)./diff(RLASMC_t)/57.3 - diff(RLASMC_psi)./diff(RLASMC_t)/57.3,'LineWidth',1.5);
